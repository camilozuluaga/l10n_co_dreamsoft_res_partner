...
class ProductProduct(models.Model):
    ...
    def _compute_product_price(self):
        ...
        if pricelist_id_or_name:
            ...
            _logger.info("//////////// computando precio")
            ...
            if pricelist:
                ...
                _logger.info("estableciendo precios")
                _logger.info( prices )
    ...
    def price_compute(self, price_type, uom=False, currency=False, company=False):
        _logger.info("PRICE COMPUTE ================")
        if 'website' in self.env.context:
            self.with_context(force_company = 6)
        ...
        _logger.info( products.list_price )
        _logger.info( self.env['product.template'].sudo().browse( products.product_tmpl_id ).list_price )
